...
return [
    ...
    */
    'ui' => [
        /*
         * URL для доступа к Swagger UI. Вы можете изменить его, если хотите.
         */
        'url' => env('LUME_SWAGGER_UI_URL', '/swagger-ui'),

        /*
         * Включить или отключить Swagger UI
         */
        'enabled' => env('LUME_SWAGGER_UI_ENABLED', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Middleware, который будет применяться к маршрутам Swagger.
    |
    */
    'middleware' => [
        'api' => [],
